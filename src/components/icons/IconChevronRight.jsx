...
// Este componente renderiza un icono SVG de una flecha apuntando a la derecha.
// Se utiliza comúnmente para indicar "siguiente" o para abrir un panel/sidebar.
...
const IconChevronRight = memo(() => (
  ...
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {/* `d="M9 5l7 7-7 7"`: Los comandos de dibujo que forman la flecha. */}
